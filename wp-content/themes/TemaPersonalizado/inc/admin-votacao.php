...
function tema_votacao_render_admin_page(): void {
    ...
    echo '<div class="tema-votacao-card"><span>Bolsonaro</span><strong>' . esc_html(number_format_i18n($totais['bolsonaro'])) . '</strong></div>';
    ...
    if (empty($rows)) {
        ...
        foreach ($rows as $r) {
            ...
            $cand_label = $cand === 'lula' ? 'Lula' : ($cand === 'bolsonaro' ? 'Bolsonaro' : $cand);
